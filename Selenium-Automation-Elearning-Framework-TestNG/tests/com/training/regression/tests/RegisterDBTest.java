...
public class RegisterDBTest {
	...
	public void RegisterTest(String firstName, String lastName, String email,long phone) throws InterruptedException {
		String phone_num = Long.toString(phone);
		registerPOM.Register();
		registerPOM.PersonalDetails(firstName, lastName, email, phone_num);
